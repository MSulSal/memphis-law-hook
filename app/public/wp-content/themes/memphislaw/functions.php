...
function memphislaw_get_icon_svg(string $icon): string
{
    return match ($icon) {
        ...
        'theme-toggle' => '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M15.4 3.4a8.8 8.8 0 1 0 5.2 14.8 7.3 7.3 0 1 1-5.2-14.8Z" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"/></svg>',
