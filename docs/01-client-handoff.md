...
- Live Google Maps embed settings
...
- Update the live office map from `Settings > Memphis Law Map`
...
- Shared contact details, footer legal disclaimer, and multi-line office hours
...
- `Appearance > Customize > Firm Details`: address, phone, email, office hours, and footer disclaimer
...
- `Settings > Memphis Law Map`: Google Maps query, optional official embed URL, optional Embed API key, and map height
