...
<header class="site-header ml-navbar">
    <div class="container site-header__inner ml-nav-inner">
        <a class="brand ml-logo" href="<?php echo esc_url(home_url('/')); ?>">
        ...
        <button
            class="site-header__toggle ml-nav-toggle"
            type="button"
            aria-expanded="false"
        ...
        <nav class="site-header__nav ml-nav-links" id="site-navigation" aria-label="<?php esc_attr_e('Primary navigation', 'memphislaw'); ?>" data-nav-panel>
            <?php
        ...
        <div class="site-header__actions ml-nav-actions">
            <a class="site-header__phone ml-nav-phone" href="<?php echo esc_url(memphislaw_get_phone_href()); ?>">
                <span class="site-header__phone-icon" aria-hidden="true"><?php echo memphislaw_get_icon_markup('contact-phone'); ?></span>
                <?php echo esc_html($contact['phone']); ?>
            </a>
            <a class="button button--small site-header__cta ml-nav-cta" href="<?php echo esc_url(home_url('/#consultation')); ?>">
                <?php echo esc_html($brand['header_consultation_label']); ?>
            </a>
            <button class="site-header__theme-toggle ml-theme-toggle" type="button" aria-pressed="false" aria-label="<?php esc_attr_e('Toggle light and dark theme', 'memphislaw'); ?>" data-theme-toggle>
